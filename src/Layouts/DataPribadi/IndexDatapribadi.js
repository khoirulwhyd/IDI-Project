...
export default function IndexDatapribadi() {
    ...
    useEffect(function () {
        axios
            .get('http://localhost:8000/api/data-pribadi')
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2">
                                                <div class="flex justify-start ...">
                                                    ...
                                                    <div className="section-avatar px-6">
                                                        ...
                                                        <p className="font-regular text-gray-400 text-sm sm:text-lg">
                                                            KTP-{dat.no_identitas}
                                                        </p>
                                                    </div>
                                                </div>
                                                    ...
                                                    <Link to="/editdatapribadi">
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                />
                                                                <path
                                                                    d="M11.6377 2.33545L15.4427 6.14045"
                                                                    stroke="white"
                                                                    stroke-width="1.5"
                                                                    stroke-linecap="round"
                                                                    stroke-linejoin="round"
                                                    ...
                                                    <tbody>
                                                        <div>
                                                            <tr class="bg-white border-b">
                                                                ...
                                                                <td class="px-6 py-4">{dat.npaidi}</td>
                                                            </tr>
                                                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                                ...
                                                                <td class="px-6 py-4">
                                                                    {dat.tempat_lahir}, {dat.tanggal_lahir}
                                                                </td>
                                                            </tr>
                                                            <tr class="bg-white border-b dark:bg-gray-800">
                                                                ...
                                                                <td class="px-6 py-4">{dat.jenis_kelamin}</td>
                                                            </tr>
                                                            <tr class="bg-white border-b dark:bg-gray-800">
                                                                <th
                                                                    scope="row"
                                                                ...
                                                                <td class="px-6 py-4">{dat.kewarganegaraan}</td>
                                                            </tr>
                                                            <tr class="bg-white border-b dark:bg-gray-800">
                                                                <th
                                                                    scope="row"
                                                                ...
                                                                <td class="px-6 py-4">{dat.agama}</td>
                                                            </tr>
                                                            <tr class="bg-white border-b dark:bg-gray-800">
                                                                <th
                                                                    scope="row"
                                                                ...
                                                                <td class="px-6 py-4">{dat.nama_pasangan}</td>
                                                            </tr>
                                                        </div>
                                                    </tbody>
                                                </table>
                                                ...
                                                <table class="table-fixed w-full text-sm text-left text-gray-500 dark:text-gray-400 md:table-fixed">
                                                    ...
                                                    <tbody>
                                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                            ...
                                                            <td class="px-6 py-4">{dat.alamat_ktp}</td>
                                                        </tr>
                                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                            <th
                                                                scope="row"
